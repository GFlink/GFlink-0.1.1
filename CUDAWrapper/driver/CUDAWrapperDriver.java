...
import CUDAWrapper.CudaException;
import CUDAWrapper.LibUtils;
import CUDAWrapper.LogLevel;
 ...
 */
public class CUDAWrapperDriver
{
    /** The CUDA version */
     ...
     * Flag for {@link CUDAWrapperDriver#cuMemHostAlloc}
     */
    public static final int CU_MEMHOSTALLOC_PORTABLE = 0x01;

    /**
     * If set, host memory is mapped into CUDA address space and
     * CUDAWrapperDriver#cuMemHostGetDevicePointer may be called on the host pointer.
     * Flag for {@link CUDAWrapperDriver#cuMemHostAlloc}
     */
    ...
    */
     ...
     * Flag for CUDAWrapperDriver#cuTexRefSetFlags()
     */
     ...
     * Flag for {@link CUDAWrapperDriver#cuStreamAddCallback(CUstream, CUstreamCallback, Object, int)}
     *
    ...
    static
    {
        String libraryBaseName = "CUDAStubDriver-" + CUDAWrapper.getCUDAWrapperVersion();
        String libraryName = 
    ...
    private CUDAWrapperDriver()
    {
    }

    /**
     * Set the specified log level for the CUDAWrapper driver library.<br />
     * <br />
     ...
     * {@link CUDAWrapperDriver#cuModuleLoadDataEx(CUmodule, Pointer, int, int[], Pointer)}
     ...
     * @see CUDAWrapperDriver#cuDeviceTotalMem
     * 
     * @deprecated Deprecated as of CUDA 5.0, replaced with {@link CUDAWrapperDriver#cuDeviceGetAttribute(int[], int, CUdevice)}
     */
    @Deprecated
     ...
     * @see CUDAWrapperDriver#cuCtxGetApiVersion
     * @see CUDAWrapperDriver#cuCtxGetCacheConfig
     * @see CUDAWrapperDriver#cuCtxGetDevice
     * @see CUDAWrapperDriver#cuCtxGetLimit
     * @see CUDAWrapperDriver#cuCtxPopCurrent
     * @see CUDAWrapperDriver#cuCtxPushCurrent
     * @see CUDAWrapperDriver#cuCtxSetCacheConfig
     * @see CUDAWrapperDriver#cuCtxSetLimit
     * @see CUDAWrapperDriver#cuCtxSynchronize
     */
     ...
     * CUDA_ERROR_INVALID_CONTEXT
     *
     * @see CUDAWrapperDriver#cuCtxGetCurrent
     * @see CUDAWrapperDriver#cuCtxCreate
     * @see CUDAWrapperDriver#cuCtxDestroy
     */
     ...
     *
     * @see CUDAWrapperDriver#cuCtxSetCurrent
     * @see CUDAWrapperDriver#cuCtxCreate
     * @see CUDAWrapperDriver#cuCtxDestroy
     */
     ...
     * @see CUDAWrapperDriver#cuModuleGetFunction
     * @see CUDAWrapperDriver#cuModuleGetGlobal
     * @see CUDAWrapperDriver#cuModuleGetSurfRef
     * @see CUDAWrapperDriver#cuModuleLoad
     * @see CUDAWrapperDriver#cuModuleLoadData
     * @see CUDAWrapperDriver#cuModuleLoadDataEx
     * @see CUDAWrapperDriver#cuModuleLoadFatBinary
     ...
     * @see CUDAWrapperDriver#cuMemAlloc
     * @see CUDAWrapperDriver#cuMemAllocHost
     * @see CUDAWrapperDriver#cuMemAllocPitch
     * @see CUDAWrapperDriver#cuMemcpy2D
     * @see CUDAWrapperDriver#cuMemcpy2DAsync
     * @see CUDAWrapperDriver#cuMemcpy2DUnaligned
     ...
     * @see CUDAWrapperDriver#cuMemcpyAtoHAsync
     * @see CUDAWrapperDriver#cuMemcpyDtoA
     * @see CUDAWrapperDriver#cuMemcpyDtoD
     * @see CUDAWrapperDriver#cuMemcpyDtoDAsync
     * @see CUDAWrapperDriver#cuMemcpyDtoH
     * @see CUDAWrapperDriver#cuMemcpyDtoHAsync
     * @see CUDAWrapperDriver#cuMemcpyHtoA
     * @see CUDAWrapperDriver#cuMemcpyHtoAAsync
     * @see CUDAWrapperDriver#cuMemcpyHtoD
     * @see CUDAWrapperDriver#cuMemcpyHtoDAsync
     * @see CUDAWrapperDriver#cuMemFree
     * @see CUDAWrapperDriver#cuMemFreeHost
     * @see CUDAWrapperDriver#cuMemGetAddressRange
     * @see CUDAWrapperDriver#cuMemHostAlloc
     * @see CUDAWrapperDriver#cuMemHostGetDevicePointer
     * @see CUDAWrapperDriver#cuMemsetD2D8
     * @see CUDAWrapperDriver#cuMemsetD2D16
     * @see CUDAWrapperDriver#cuMemsetD2D32
     * @see CUDAWrapperDriver#cuMemsetD8
     * @see CUDAWrapperDriver#cuMemsetD16
     * @see CUDAWrapperDriver#cuMemsetD32
     */
     ...
     * @see CUDAWrapperDriver#cuMemFreeHost
     * @see CUDAWrapperDriver#cuMemGetAddressRange
     * @see CUDAWrapperDriver#cuMemGetInfo
     * @see CUDAWrapperDriver#cuMemHostGetDevicePointer
     * @see CUDAWrapperDriver#cuMemsetD2D8
     * @see CUDAWrapperDriver#cuMemsetD2D16
     * @see CUDAWrapperDriver#cuMemsetD2D32
     ...
     * @see CUDAWrapperDriver#cuDeviceGet
     * @see CUDAWrapperDriver#cuDeviceGetAttribute
     * @see CUDAWrapperDriver#cuDeviceGetPCIBusId
     */
     ...
     * @see CUDAWrapperDriver#cuMemsetD32
     * @see CUDAWrapperDriver#cuDeviceGetAttribute
     * @see CUDAWrapperDriver#cuStreamAttachMemAsync
     */
     ...
     * @see CUDAWrapperDriver#cuDeviceGet
     * @see CUDAWrapperDriver#cuDeviceGetAttribute
     * @see CUDAWrapperDriver#cuDeviceGetByPCIBusId
     */
     ...
     * @see CUDAWrapperDriver#cuStreamWaitEvent
     * @see CUDAWrapperDriver#cuIpcOpenEventHandle
     * @see CUDAWrapperDriver#cuIpcGetMemHandle
     * @see CUDAWrapperDriver#cuIpcOpenMemHandle
     * @see CUDAWrapperDriver#cuIpcCloseMemHandle
     */
     ...
     * @see CUDAWrapperDriver#cuEventQuery
     * @see CUDAWrapperDriver#cuStreamWaitEvent
     * @see CUDAWrapperDriver#cuIpcGetEventHandle
     * @see CUDAWrapperDriver#cuIpcGetMemHandle
     * @see CUDAWrapperDriver#cuIpcOpenMemHandle
     * @see CUDAWrapperDriver#cuIpcCloseMemHandle
     */
     ...
     * @see CUDAWrapperDriver#cuIpcGetMemHandle
     * @see CUDAWrapperDriver#cuIpcCloseMemHandle
     * @see CUDAWrapperDriver#cuCtxEnablePeerAccess
     * @see CUDAWrapperDriver#cuDeviceCanAccessPeer
     */
     ...
     * CUDA_ERROR_OUT_OF_MEMORY, CUDA_ERROR_HOST_MEMORY_ALREADY_REGISTERED
     *
     * @see CUDAWrapperDriver#cuMemHostUnregister
     * @see CUDAWrapperDriver#cuMemHostGetFlags
     * @see CUDAWrapperDriver#cuMemHostGetDevicePointer
     */
     ...
     *
     * @see CUDAWrapperDriver#cuMemHostRegister
     */
     ...
     *
     * @see CUDAWrapperDriver#cuMemcpyDtoD
     * @see CUDAWrapperDriver#cuMemcpy3DPeer
     * @see CUDAWrapperDriver#cuMemcpyDtoDAsync
     * @see CUDAWrapperDriver#cuMemcpyPeerAsync
     * @see CUDAWrapperDriver#cuMemcpy3DPeerAsync
     */
     ...
     *
     * @see CUDAWrapperDriver#cuMemcpyDtoD
     * @see CUDAWrapperDriver#cuMemcpyPeer
     * @see CUDAWrapperDriver#cuMemcpyDtoDAsync
     * @see CUDAWrapperDriver#cuMemcpyPeerAsync
     * @see CUDAWrapperDriver#cuMemcpy3DPeerAsync
     */
     ...
     * @see CUDAWrapperDriver#cuMemHostGetDevicePointer
     * @see CUDAWrapperDriver#cuMemsetD2D8
     * @see CUDAWrapperDriver#cuMemsetD2D8Async
     * @see CUDAWrapperDriver#cuMemsetD2D16
     * @see CUDAWrapperDriver#cuMemsetD2D16Async
     * @see CUDAWrapperDriver#cuMemsetD2D32
     * @see CUDAWrapperDriver#cuMemsetD2D32Async
     * @see CUDAWrapperDriver#cuMemsetD8
     * @see CUDAWrapperDriver#cuMemsetD8Async
     * @see CUDAWrapperDriver#cuMemsetD16
     * @see CUDAWrapperDriver#cuMemsetD16Async
     * @see CUDAWrapperDriver#cuMemsetD32
     * @see CUDAWrapperDriver#cuMemsetD32Async
     */
     ...
     * @see CUDAWrapperDriver#cuCtxGetCacheConfig
     * @see CUDAWrapperDriver#cuCtxSetCacheConfig
     * @see CUDAWrapperDriver#cuFuncSetCacheConfig
     * @see CUDAWrapperDriver#cuLaunchKernel
     */
     ...
     * CUDA_ERROR_INVALID_VALUE
     *
     * @see CUDAWrapperDriver#cuFuncSetSharedSize
     * @see CUDAWrapperDriver#cuFuncSetCacheConfig
     * @see CUDAWrapperDriver#cuFuncGetAttribute
     * @see CUDAWrapperDriver#cuParamSetSize
     * @see CUDAWrapperDriver#cuParamSeti
     * @see CUDAWrapperDriver#cuParamSetf
     * @see CUDAWrapperDriver#cuParamSetv
     * @see CUDAWrapperDriver#cuLaunch
     * @see CUDAWrapperDriver#cuLaunchGrid
     * @see CUDAWrapperDriver#cuLaunchGridAsync
     * @see CUDAWrapperDriver#cuLaunchKernel
     * 
     * @deprecated Deprecated in CUDA
     */
     ...
     * CUDA_ERROR_INVALID_VALUE
     *
     * @see CUDAWrapperDriver#cuFuncSetBlockShape
     * @see CUDAWrapperDriver#cuFuncSetCacheConfig
     * @see CUDAWrapperDriver#cuFuncGetAttribute
     * @see CUDAWrapperDriver#cuParamSetSize
     * @see CUDAWrapperDriver#cuParamSeti
     ...
     * @see CUDAWrapperDriver#cuCtxGetCacheConfig
     * @see CUDAWrapperDriver#cuCtxSetCacheConfig
     * @see CUDAWrapperDriver#cuCtxGetSharedMemConfig
     * @see CUDAWrapperDriver#cuCtxSetSharedMemConfigcuFuncGetAttribute
     * @see CUDAWrapperDriver#cuLaunchKernel
     */
     ...
     * CUDA_ERROR_OUT_OF_MEMORY, CUDA_ERROR_UNKNOWN
     *
     * @see CUDAWrapperDriver#cuMipmappedArrayDestroy
     * @see CUDAWrapperDriver#cuMipmappedArrayGetLevel
     * @see CUDAWrapperDriver#cuArrayCreate
     */
     ...
     * CUDA_ERROR_INVALID_HANDLE
     *
     * @see CUDAWrapperDriver#cuMipmappedArrayCreate
     * @see CUDAWrapperDriver#cuMipmappedArrayDestroy
     * @see CUDAWrapperDriver#cuArrayCreate
     */
     ...
     * @see CUDAWrapperDriver#cuTexRefSetAddress2D
     ...
     * @see CUDAWrapperDriver#cuTexRefSetAddressMode
     * @see CUDAWrapperDriver#cuTexRefGetAddressMode
     * @see CUDAWrapperDriver#cuTexRefGetBorderColor
     */
     ...
     * @see CUDAWrapperDriver#cuTexRefSetAddressMode
     * @see CUDAWrapperDriver#cuTexRefSetAddressMode
     * @see CUDAWrapperDriver#cuTexRefSetBorderColor
     */
     ...
     *
     * @see CUDAWrapperDriver#cuModuleGetSurfRef
     * @see CUDAWrapperDriver#cuSurfRefGetArray
     */
     ...
     *
     * @see CUDAWrapperDriver#cuModuleGetSurfRef
     * @see CUDAWrapperDriver#cuSurfRefSetArray
     */
     ...
     * CUDA_ERROR_INVALID_CONTEXT, CUDA_ERROR_INVALID_VALUE
     *
     * @see CUDAWrapperDriver#cuTexObjectDestroy
     */
     ...
     * CUDA_ERROR_INVALID_CONTEXT, CUDA_ERROR_INVALID_VALUE
     *
     * @see CUDAWrapperDriver#cuTexObjectCreate
     */
     ...
     * CUDA_ERROR_INVALID_CONTEXT, CUDA_ERROR_INVALID_VALUE
     *
     * @see CUDAWrapperDriver#cuSurfObjectDestroy
     */
     ...
     * CUDA_ERROR_INVALID_CONTEXT, CUDA_ERROR_INVALID_VALUE
     *
     * @see CUDAWrapperDriver#cuSurfObjectCreate
     */
     ...
     *
     * @see CUDAWrapperDriver#cuCtxEnablePeerAccess
     * @see CUDAWrapperDriver#cuCtxDisablePeerAccess
     */
     ...
     * @see CUDAWrapperDriver#cuCtxEnablePeerAccess
     * @see CUDAWrapperDriver#cuCtxDisablePeerAccess
     * @see CUDAWrapperDriver#cuCtxCanAccessPeer
     */
     ...
     * 
     * @see CUDAWrapperDriver#cuStreamWriteValue32
     * @see CUDAWrapperDriver#cuStreamBatchMemOp
     * @see CUDAWrapperDriver#cuMemHostRegister
     * @see CUDAWrapperDriver#cuStreamWaitEvent
     */
     ...
     * @return CUDA_SUCCESS, CUDA_ERROR_INVALID_VALUE, CUDA_ERROR_NOT_SUPPORTED
     * 
     * @see CUDAWrapperDriver#cuStreamWaitValue32
     * @see CUDAWrapperDriver#cuStreamBatchMemOp
     * @see CUDAWrapperDriver#cuMemHostRegister
     * @see CUDAWrapperDriver#cuEventRecord
     */
    ...
    /**
     * <br>
     * <b>NOTE: This function is not yet supported in CUDAWrapper, and will throw an
    ...
    public static int cuStreamBatchMemOp(CUstream stream, int count, CUstreamBatchMemOpParams paramArray[], int flags)
    {
        ...
        throw new UnsupportedOperationException("The cuStreamBatchMemOp function is not yet supported in CUDAWrapper");
    }
     ...
     *
     * @see CUDAWrapperDriver#cuMemcpy
     * @see CUDAWrapperDriver#cuMemcpyPeer
     * @see CUDAWrapperDriver#cuMemcpyAsync
     * @see CUDAWrapperDriver#cuMemcpy3DPeerAsync
     * @see CUDAWrapperDriver#cuMemAdvise
     */
     ...
     * @see CUDAWrapperDriver#cuMemcpyAsync
     * @see CUDAWrapperDriver#cuMemcpy3DPeerAsync
     * @see CUDAWrapperDriver#cuMemPrefetchAsync
     */
     ...
     * @return CUDA_SUCCESS, CUDA_ERROR_INVALID_VALUE, CUDA_ERROR_INVALID_DEVICE
     * 
     * @see CUDAWrapperDriver#cuMemRangeGetAttributes
     * @see CUDAWrapperDriver#cuMemPrefetchAsync
     * @see CUDAWrapperDriver#cuMemAdvise
     */
     ...
     * {@link CUDAWrapperDriver#cuMemRangeGetAttribute} for attribute descriptions and
     * restrictions.
     * <ul>
     ...
     *
     * @see CUDAWrapperDriver#cuPointerGetAttribute,
     * @see CUDAWrapperDriver#cuPointerGetAttributes,
     * @see CUDAWrapperDriver#cuMemAlloc,
     * @see CUDAWrapperDriver#cuMemFree,
     * @see CUDAWrapperDriver#cuMemAllocHost,
     * @see CUDAWrapperDriver#cuMemFreeHost,
     ...
     *
     * @see CUDAWrapperDriver#cuPointerGetAttribute,
     * @see CUDAWrapperDriver#cuPointerSetAttribute
     */
     ...
     * @see CUDAWrapperDriver#cuStreamAddCallback
     */
     ...
     *
     * @see CUDAWrapperDriver#cuGLMapBufferObject
     * @see CUDAWrapperDriver#cuGLRegisterBufferObject
     * @see CUDAWrapperDriver#cuGLUnmapBufferObject
     * @see CUDAWrapperDriver#cuGLUnregisterBufferObject
     * @see CUDAWrapperDriver#cuGLMapBufferObjectAsync
     * @see CUDAWrapperDriver#cuGLUnmapBufferObjectAsync
     * @see CUDAWrapperDriver#cuGLSetBufferObjectMapFlags
     * 
     ...
     *
     * @see CUDAWrapperDriver#cuCtxCreate
     * @see CUDAWrapperDriver#cuGLInit
     * @see CUDAWrapperDriver#cuGLMapBufferObject
     * @see CUDAWrapperDriver#cuGLRegisterBufferObject
     * @see CUDAWrapperDriver#cuGLUnmapBufferObject
     * @see CUDAWrapperDriver#cuGLUnregisterBufferObject
     ...
     * CUDA_ERROR_INVALID_CONTEXT,
     *
     * @see CUDAWrapperDriver#cuGraphicsUnregisterResource
     * @see CUDAWrapperDriver#cuGraphicsMapResources
     * @see CUDAWrapperDriver#cuGraphicsResourceGetMappedPointer
     */
     ...
     * @see CUDAWrapperDriver#cuGraphicsUnregisterResource
     * @see CUDAWrapperDriver#cuGraphicsMapResources
     * @see CUDAWrapperDriver#cuGraphicsSubResourceGetMappedArray
     */
     ...
     *
     * @see CUDAWrapperDriver#cuGraphicsGLRegisterBuffer
     * 
     * @deprecated Deprecated as of CUDA 3.0
     */
    @Deprecated
     ...
     * CUDA_ERROR_INVALID_CONTEXT, CUDA_ERROR_INVALID_VALUE
     *
     * @see CUDAWrapperDriver#cuGraphicsUnmapResources
     * 
     * @deprecated Deprecated as of CUDA 3.0
     */
    @Deprecated
     ...
     *
     * @see CUDAWrapperDriver#cuGraphicsResourceSetMapFlags
     * 
     * @deprecated Deprecated as of CUDA 3.0
     */
    @Deprecated
     ...
     *
     * @see CUDAWrapperDriver#cuGraphicsGLRegisterBuffer
     * @see CUDAWrapperDriver#cuGraphicsGLRegisterImage
     */
     ...
     * @return CUDA_SUCCESS, CUDA_ERROR_INVALID_VALUE
     *
     * @see CUDAWrapperDriver#cuStreamCreateWithPriority
     * @see CUDAWrapperDriver#cuStreamGetPriority,
     * @see CUDAWrapperDriver#cuCtxGetDevice,
     * @see CUDAWrapperDriver#cuCtxSetLimit,
     * @see CUDAWrapperDriver#cuCtxSynchronize
     */
     ...
     *
     * @see CUDAWrapperDriver#cuProfilerStart
     * @see CUDAWrapperDriver#cuProfilerStop
     */
