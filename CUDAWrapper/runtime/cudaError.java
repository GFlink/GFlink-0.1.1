...
import CUDAWrapper.driver.CUcontext;
...
public class cudaError
{
     ...
     * {@link CUDAWrapper#cudaEventQuery} and {@link CUDAWrapper#cudaStreamQuery}).
     */
    public static final int cudaSuccess                           =      0;

    /**
     * The device function being invoked (usually via {@link CUDAWrapper#cudaLaunch}) was not
     * previously configured via the {@link CUDAWrapper#cudaConfigureCall} function.
     */
     ...
     * {@link CUDAWrapper#cudaThreadExit} is called. All existing device memory allocations
     ...
     * for more information. The device cannot be used until {@link CUDAWrapper#cudaThreadExit}
     ...
     * call {@link CUDAWrapper#cudaGetTextureAlignmentOffset} with an unbound texture.
     */
     ...
     * {@link CUDAWrapper#cudaGetSymbolAddress}.
     */
     ...
     * may return this value include {@link CUDAWrapper#cudaEventQuery} and {@link CUDAWrapper#cudaStreamQuery}.
     */
     ...
     * {@link CUDAWrapper#cudaSetValidDevices(int[], int)},
     * {@link CUDAWrapper#cudaSetDeviceFlags(int)},
    ...
    /**
     * This error indicates that a call to {@link CUDAWrapper#cudaDeviceEnablePeerAccess} is
    ...
    /**
     * This error indicates that a call to {@link CUDAWrapper#cudaDeviceEnablePeerAccess } trying to
     * register memory from a context which has not had peer addressing
     * enabled yet via {@link CUDAWrapper#cudaDeviceEnablePeerAccess}, or that
     * {@link CUDAWrapper#cudaDeviceDisablePeerAccess} is trying to disable peer addressing
     ...
     * to attempt to enable/disable the profiling via {@link CUDAWrapper#cudaProfilerStart()} or
     *  {@link CUDAWrapper#cudaProfilerStop()} without initialization.
     */
     ...
     * @deprecated
     * This error return is deprecated as of CUDA 5.0. It is no longer an error
     * to call  {@link CUDAWrapper#cudaProfilerStart()} when profiling is already enabled.
     */
     ...
     * @deprecated
     * This error return is deprecated as of CUDA 5.0. It is no longer an error
     * to call  {@link CUDAWrapper#cudaProfilerStop()} when profiling is already disabled.
     */
    public static final int cudaErrorProfilerAlreadyStopped       =     58;

    /**
     * An assert triggered in device code during kernel execution. The device
     * cannot be used again until {@link CUDAWrapper#cudaThreadExit()} is called. All existing
     ...
     * {@link CUDAWrapper#cudaHostRegister(Pointer, long, int)}
     ...
     * {@link CUDAWrapper#cudaHostUnregister(Pointer)}
    ...
    /**
     * An internal CUDAWrapper error occurred
     */
    public static final int CUDAWrapperInternalError = 0x80000001;
    ...
    public static String stringFor(int error)
    {
        switch (error)
        {
            ...
            case CUDAWrapperInternalError                    : return "CUDAWrapperInternalError";
        }
