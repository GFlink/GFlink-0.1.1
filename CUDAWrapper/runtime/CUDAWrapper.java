...
public class CUDAWrapper
{
     ...
     * 
     * @return The CUDAWrapper version  
     */
    public static String getCUDAWrapperVersion()
    {
        return "0.8.0";
    }
    ...
    public static void initialize()
    {
        if (!initialized)
        {
            String libraryBaseName = "CUDAStubRuntime-" + getCUDAWrapperVersion();
            String libraryName = 
    ...
    /**
     * Set the specified log level for the CUDAWrapper runtime library.<br />
     * <br />
     ...
     *
     * @see CUDAWrapper#cudaGetDevice
     * @see CUDAWrapper#cudaSetDevice
     * @see CUDAWrapper#cudaGetDeviceProperties
     * @see CUDAWrapper#cudaChooseDevice
     */
     ...
     *
     * @see CUDAWrapper#cudaGetDeviceCount
     * @see CUDAWrapper#cudaGetDevice
     * @see CUDAWrapper#cudaGetDeviceProperties
     * @see CUDAWrapper#cudaChooseDevice
     */
     ...
     * @see CUDAWrapper#cudaGetDeviceProperties
     * @see CUDAWrapper#cudaSetDevice
     * @see CUDAWrapper#cudaSetValidDevices
     * @see CUDAWrapper#cudaChooseDevice
     */
     ...
     * @see CUDAWrapper#cudaGetDeviceProperties
     * @see CUDAWrapper#cudaSetDevice
     * @see CUDAWrapper#cudaSetDeviceFlags
     */
     ...
     * @see CUDAWrapper#cudaSetDevice
     * @see CUDAWrapper#cudaChooseDevice
     * @see CUDAWrapper#cudaDeviceGetAttribute
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidDevice, cudaErrorInvalidValue
     *
     * @see CUDAWrapper#cudaCtxEnablePeerAccess
     * @see CUDAWrapper#cudaCtxDisablePeerAccess
     * @see CUDAWrapper#cudaCtxCanAccessPeer
     */
     ...
     *
     * @see CUDAWrapper#cudaMallocPitch
     * @see CUDAWrapper#cudaFree
     ...
     * @see CUDAWrapper#cudaMallocHost
     * @see CUDAWrapper#cudaFreeHost
     * @see CUDAWrapper#cudaHostAlloc
     * @see cudaPitchedPtr
     * @see cudaExtent
     */
     ...
     *
     * @see CUDAWrapper#cudaMemset
     * @see CUDAWrapper#cudaMemset2D
     * @see CUDAWrapper#cudaMemsetAsync
     * @see CUDAWrapper#cudaMemset2DAsync
     * @see CUDAWrapper#cudaMemset3DAsync
     * @see CUDAWrapper#cudaMalloc3D
     * @see cudaPitchedPtr
     * @see cudaExtent
     */
     ...
     * @see CUDAWrapper#cudaMalloc3DArray
     * @see CUDAWrapper#cudaMemset3D
     * @see CUDAWrapper#cudaMemcpy3DAsync
     * @see CUDAWrapper#cudaMemcpy
     * @see CUDAWrapper#cudaMemcpy2D
     * @see CUDAWrapper#cudaMemcpyToArray
     * @see CUDAWrapper#cudaMemcpy2DToArray
     * @see CUDAWrapper#cudaMemcpyFromArray
     * @see CUDAWrapper#cudaMemcpy2DFromArray
     * @see CUDAWrapper#cudaMemcpyArrayToArray
     * @see CUDAWrapper#cudaMemcpy2DArrayToArray
     * @see CUDAWrapper#cudaMemcpyToSymbol
     * @see CUDAWrapper#cudaMemcpyFromSymbol
     * @see CUDAWrapper#cudaMemcpyAsync
     * @see CUDAWrapper#cudaMemcpy2DAsync
     * @see CUDAWrapper#cudaMemcpyToArrayAsync
     * @see CUDAWrapper#cudaMemcpy2DToArrayAsync
     * @see CUDAWrapper#cudaMemcpyFromArrayAsync
     * @see CUDAWrapper#cudaMemcpy2DFromArrayAsync
     * @see CUDAWrapper#cudaMemcpyToSymbolAsync
     * @see CUDAWrapper#cudaMemcpyFromSymbolAsync
     * @see cudaExtent
     * @see cudaPos
     */
     ...
     *
     * @see CUDAWrapper#cudaMemcpy
     * @see CUDAWrapper#cudaMemcpyPeer
     * @see CUDAWrapper#cudaMemcpyAsync
     * @see CUDAWrapper#cudaMemcpyPeerAsync
     * @see CUDAWrapper#cudaMemcpy3DPeerAsync
     */
     ...
     *
     * @see CUDAWrapper#cudaHostUnregister
     * @see CUDAWrapper#cudaHostGetFlags
     * @see CUDAWrapper#cudaHostGetDevicePointer
     */
     ...
     * @see CUDAWrapper#cudaHostAlloc
     * @see CUDAWrapper#cudaDeviceGetAttribute
     * @see CUDAWrapper#cudaStreamAttachMemAsync
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue
     *
     * @see CUDAWrapper#cudaCreateChannelDesc
     * @see CUDAWrapper#cudaGetTextureReference
     * @see CUDAWrapper#cudaBindTexture
     * @see CUDAWrapper#cudaBindTexture2D
     * @see CUDAWrapper#cudaBindTextureToArray
     * @see CUDAWrapper#cudaUnbindTexture
     * @see CUDAWrapper#cudaGetTextureAlignmentOffset
     */
     ...
     *
     * @see CUDAWrapper#cudaCreateChannelDesc
     * @see CUDAWrapper#cudaGetChannelDesc
     * @see CUDAWrapper#cudaGetTextureReference
     * @see CUDAWrapper#cudaBindTexture
     * @see CUDAWrapper#cudaBindTexture
     *
     ...
     *
     * @see CUDAWrapper#cudaPeekAtLastError
     * @see CUDAWrapper#cudaGetErrorString
     *
     */
     ...
     * cudaErrorSetOnActiveProcess, cudaErrorStartupFailure,
     *
     * @see CUDAWrapper#cudaGetLastError
     * @see CUDAWrapper#cudaGetErrorString
     *
     */
     ...
     * @see CUDAWrapper#cudaStreamCreateWithFlags
     * @see CUDAWrapper#cudaStreamQuery
     * @see CUDAWrapper#cudaStreamSynchronize
     * @see CUDAWrapper#cudaStreamWaitEvent
     * @see CUDAWrapper#cudaStreamAddCallback
     ...
     * @see CUDAWrapper#cudaEventCreateWithFlags
     ...
     * @return cudaSuccess
     *
     * @see CUDAWrapper#cudaDeviceSynchronize
     */
     ...
     * @return cudaSuccess
     *
     * @see CUDAWrapper#cudaDeviceReset
     */
     ...
     *
     * @see CUDAWrapper#cudaDeviceGetLimit
     */
     ...
     * @return cudaSuccess, cudaErrorUnsupportedLimit, cudaErrorInvalidValue
     *
     * @see CUDAWrapper#cudaDeviceSetLimit
     */
     ...
     * @return cudaSuccess, cudaErrorInitializationError
     *
     * @see CUDAWrapper#cudaDeviceSetCacheConfig
     * @see CUDAWrapper#cudaDeviceSetCacheConfig
     * @see CUDAWrapper#cudaDeviceSetCacheConfig
     */
     ...
     *
     * @see CUDAWrapper#cudaDeviceSetCacheConfig
     * @see CUDAWrapper#cudaDeviceGetCacheConfig
     * @see CUDAWrapper#cudaDeviceSetSharedMemConfig
     * @see CUDAWrapper#cudaDeviceSetCacheConfig
     */
     ...
     * @see CUDAWrapper#cudaDeviceSetCacheConfig
     * @see CUDAWrapper#cudaDeviceGetCacheConfig
     * @see CUDAWrapper#cudaDeviceGetSharedMemConfig
     * @see CUDAWrapper#cudaDeviceSetCacheConfig
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue, cudaErrorInvalidDevice
     *
     * @see CUDAWrapper#cudaDeviceGetPCIBusId
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue, cudaErrorInvalidDevice
     *
     * @see CUDAWrapper#cudaDeviceGetByPCIBusId
     */
     ...
     * @see CUDAWrapper#cudaEventQuery
     * @see CUDAWrapper#cudaStreamWaitEvent
     * @see CUDAWrapper#cudaIpcOpenEventHandle
     * @see CUDAWrapper#cudaIpcGetMemHandle
     * @see CUDAWrapper#cudaIpcOpenMemHandle
     * @see CUDAWrapper#cudaIpcCloseMemHandle
     */
     ...
     * @see CUDAWrapper#cudaEventQuery
     * @see CUDAWrapper#cudaStreamWaitEvent
     * @see CUDAWrapper#cudaIpcGetEventHandle
     * @see CUDAWrapper#cudaIpcGetMemHandle
     * @see CUDAWrapper#cudaIpcOpenMemHandle
     * @see CUDAWrapper#cudaIpcCloseMemHandle
     */
     ...
     * @see CUDAWrapper#cudaIpcGetMemHandle
     * @see CUDAWrapper#cudaIpcCloseMemHandle
     * @see CUDAWrapper#cudaDeviceEnablePeerAccess
     * @see CUDAWrapper#cudaDeviceCanAccessPeer
     */
     ...
     *
     * @see CUDAWrapper#cudaGetSymbolAddress
     * @see CUDAWrapper#cudaGetSymbolSize
     *
     * @deprecated This function is no longer supported as of CUDA 5.0
     */
     ...
     * @see CUDAWrapper#cudaMemcpyAsync
     * @see CUDAWrapper#cudaMemcpy3DPeerAsync
     * @see CUDAWrapper#cudaMemPrefetchAsync
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue
     * 
     * @see CUDAWrapper#cudaMemRangeGetAttributes
     * @see CUDAWrapper#cudaMemPrefetchAsync
     * @see CUDAWrapper#cudaMemAdvise
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue
     * 
     * @see CUDAWrapper#cudaMemRangeGetAttribute
     * @see CUDAWrapper#cudaMemAdvisecudaMemPrefetchAsync
     */
     ...
     *
     * @see CUDAWrapper#cudaBindSurfaceToArray
     * @see CUDAWrapper#cudaBindSurfaceToArray
     *
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue
     *
     * @see CUDAWrapper#cudaDestroyTextureObject
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue
     *
     * @see CUDAWrapper#cudaCreateTextureObject
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue
     *
     * @see CUDAWrapper#cudaDestroySurfaceObject
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue
     *
     * @see CUDAWrapper#cudaCreateSurfaceObject
     */
     ...
     *
     * @see CUDAWrapper#cudaDeviceSetCacheConfig
     * @see CUDAWrapper#cudaFuncGetAttributes
     * @see CUDAWrapper#cudaLaunch
     * @see CUDAWrapper#cudaSetDoubleForDevice
     * @see CUDAWrapper#cudaSetDoubleForHost
     * @see CUDAWrapper#cudaSetupArgument
     *
     ...
     * @see CUDAWrapper#cudaSetDoubleForHost
     * @see CUDAWrapper#cudaSetupArgument
     * @see CUDAWrapper#cudaThreadGetCacheConfig
     * @see CUDAWrapper#cudaThreadSetCacheConfig
     *
     * @deprecated This function is no longer supported as of CUDA 5.0
     */
     ...
     * cudaErrorSetOnActiveProcess
     *
     * @see CUDAWrapper#cudaGraphicsGLRegisterBuffer
     * @see CUDAWrapper#cudaGraphicsGLRegisterImage
     * 
     ...
     *
     * @see CUDAWrapper#cudaGraphicsUnregisterResource
     * @see CUDAWrapper#cudaGraphicsMapResources
     * @see CUDAWrapper#cudaGraphicsSubResourceGetMappedArray
     * @see CUDAWrapper#cudaGraphicsResourceGetMappedPointer
     */
     ...
     *
     * @see CUDAWrapper#cudaGraphicsUnmapResources
     * 
     * @deprecated Deprecated as of CUDA 3.0
     */
    @Deprecated
     ...
     * cudaErrorUnknown
     *
     * @see CUDAWrapper#cudaGraphicsResourceSetMapFlags
     * 
     * @deprecated Deprecated as of CUDA 3.0
     */
    @Deprecated
     ...
     * @return cudaSuccess, cudaErrorInvalidValue
     *
     * @see CUDAWrapper#cudaRuntimeGetVersion
     */
     ...
     * @return cudaSuccess, cudaErrorInvalidValue
     *
     * @see CUDAWrapper#cudaDriverGetVersion
     */
     ...
     *
     * @see CUDAWrapper#cudaDeviceEnablePeerAccess
     * @see CUDAWrapper#cudaDeviceDisablePeerAccess
     */
     ...
     *
     * @see CUDAWrapper#cudaGraphicsD3D9RegisterResource
     * @see CUDAWrapper#cudaGraphicsD3D10RegisterResource
     * @see CUDAWrapper#cudaGraphicsD3D11RegisterResource
     * @see CUDAWrapper#cudaGraphicsGLRegisterBuffer
     * @see CUDAWrapper#cudaGraphicsGLRegisterImage
     */
     ...
     *
     * @see CUDAWrapper#cudaProfilerStart
     * @see CUDAWrapper#cudaProfilerStop
     */
     ...
     * @return cudaSuccess
     *
     * @see CUDAWrapper#cudaProfilerInitialize
     * @see CUDAWrapper#cudaProfilerStop
     */
