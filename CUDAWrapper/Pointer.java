...
public class Pointer extends NativePointerObject
{
     ...
     * Solely for the constant pointer instances in the CUDAWrapperDriver
     ...
     * methods:
     * <ul>
     *   <li>{@link CUDAWrapperDriver#cuMemAllocHost}</li>
     *   <li>{@link CUDAWrapperDriver#cuMemHostAlloc}</li>
     *   <li>{@link CUDAWrapperDriver#cuMemAllocManaged}</li>
     *   <li>{@link CUDAWrapper#cudaMallocHost}</li>
     *   <li>{@link CUDAWrapper#cudaHostAlloc}</li>
     *   <li>{@link CUDAWrapper#cudaMallocManaged}</li>
